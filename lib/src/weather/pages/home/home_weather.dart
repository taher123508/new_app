...
class HomeWeather extends GetView<HomeController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('الطقس'),centerTitle: true,
      ...
      body: GetBuilder<HomeController>(
          init:HomeController(city: '') ,

          builder: (controller) {

            return controller.dataList.length != 0&&  controller.currentWeatherData.name!=null
                ? Column(
              children: <Widget>[
                Expanded(
                  flex: 1,
